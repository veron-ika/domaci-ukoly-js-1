...
const justFoodFunct = (pocetLidi) => {
    return `cateringem od Just Food pro ${pocetLidi} lidí za ${Math.round(pocetLidi *120)} Kč.`
}

const yourMamaFunct = (pocetLidi) => {
    return `cateringem od Your Mama pro ${pocetLidi} lidí za ${Math.round(pocetLidi * 500)} Kč.`
}

const flavourHavenFunct = (pocetLidi) => {
    return `cateringem od Flavour Heaven pro ${pocetLidi} lidí za ${Math.round(pocetLidi * 3000)} Kč.`
}
